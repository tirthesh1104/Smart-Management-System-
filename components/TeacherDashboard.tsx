...
const TeacherDashboard: React.FC<TeacherDashboardProps> = ({ 
  user, onLogout, students, setStudents, onUpdateUser, leaveApplications, onUpdateLeaveStatus, 
  exams, examSubmissions, onSaveExam, onDeleteExam, onDeleteSubmission, 
  liveClasses, onScheduleClass, onDeleteClass, onUpdateClassStatus,
  events, onCreateEvent, onUpdateEvent, onDeleteEvent,
  announcements, onCreateAnnouncement,
  ...
  const [activeTab, setActiveTab] = useState<'daily' | 'live' | 'records' | 'files' | 'links' | 'overview' | 'leave' | 'exams' | 'events' | 'announcements' | 'calendar'>('daily');
    ...
    <>
      ...
      <main className="container mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <AnimatedElement className="border-b border-gray-700 mb-6" delay={100}>
          <nav className="-mb-px flex flex-wrap space-x-6" aria-label="Tabs">
            ...
            <button
              ...
              className={`tab-button py-3 px-1 font-medium text-sm text-gray-400 hover:text-white ${activeTab === 'calendar' ? 'active' : ''}`}
        ...
        <AnimatedElement>
          ...
          {activeTab === 'calendar' && (
            <CalendarView events={events} liveClasses={liveClasses} />
          )}
