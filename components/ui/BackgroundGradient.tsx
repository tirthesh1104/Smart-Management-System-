...
export const BackgroundGradient: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  return (
    <div className="relative min-h-screen w-full bg-gray-950 text-gray-100">
      <div className="fixed inset-0 w-full h-full bg-gray-950 pointer-events-none overflow-hidden z-0">
